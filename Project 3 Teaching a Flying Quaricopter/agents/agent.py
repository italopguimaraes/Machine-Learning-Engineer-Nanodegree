...
class Actor:
    ...
    def build_model(self):
        ...
        net = layers.Dense(units=128, activation='elu')(net)
        net = layers.BatchNormalization()(net)
...
class Critic:
    ...
    def build_model(self):
        ...
        net_states = layers.Dense(units=128, activation='elu')(net_states)
        net_states = layers.BatchNormalization()(net_states)
        ...
        net_actions = layers.Dense(units=128, activation='elu')(net_actions)
        net_actions = layers.BatchNormalization()(net_actions)
...
class DDPG():
    ...
    def __init__(self, task):
        ...
        self.exploration_theta = 3*0.15
        self.exploration_sigma = 3*0.2
